    ...
    class Program
    {
       ...
       public void SpawnBullet(Vector2 pos, Vector2 dir)
        ...
        void SpawnNewAsteroid()
        {
            ...
            if (side == 0) SpawnAsteroid(new Vector2(0, rand.Next(0, windowH)), dir);

            if (side == 1) SpawnAsteroid(new Vector2(rand.Next(0, windowW), 0), dir);

            if (side == 2) SpawnAsteroid(new Vector2(windowW, rand.Next(0, windowH)), dir);

            if (side == 3) SpawnAsteroid(new Vector2(rand.Next(0, windowW), windowH), dir);
